...
namespace EF6CodeFirst.Controllers
{
    ...
    {
        private NMugMeetingEntities db = new NMugMeetingEntities();
        ...
        {
            ViewBag.MeetingId = new SelectList(db.Meetings, "MeetingId", "MeetingId");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "MemberId,MeetingId,IsAttending,CreationDateTime")] MeetingMember meetingMember)
        {
            if (ModelState.IsValid)
            {
